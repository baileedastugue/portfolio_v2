    ...
    <Box id={props.id} style={{ paddingTop: '120px', marginTop: '-120px' }}>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            ...
            <br />
            <br />
            Contributed to Salesforce SiteGenesis code base to improve eCommerce
            site using CI/CD methodologies and collaborating with overseas
            development team.
            <br />
            <br />
            Developed an Image Uploader Tool for eCommerce that enabled the team
            to upload, store, and access images and videos hosted on Cloudinary
            without providing them full access to the shared business account.
            This ensured optimized asset URLs were utilized on the site which
            improved performance and prevented impact to other assets hosted
            within the account.
            <br />
            <br />
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          banners, landing pages, and category headers while collaborating with
          web merchandising, creative, and copy team, complying with ADA
          ...
          <br />
          <br />
          Coded reusable, flexible, and ADA-compliant category header templates
          for the eCommerce team that decreased product listing page load times,
          decreased cumulative layout shift, and improved core web vitals.
          <br />
          <br />
          Delivered __ engraving products on schedule while working with
          third-party vendors and improving customer experience by ensuring the
          front-end rendering matches the physical engraving. Launched __ custom
          Color Bar products and __ Color Bar stones on schedule.
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
        ...
        >
          <Typography>Trilogy Education - Full Stack Private Tutor</Typography>
        </AccordionSummary>
        <AccordionDetails>
          Taught current Trilogy bootcamp students a wide range of topics
          depending on their needs, focusing on a foundational understanding of
          topics and gradually building in complexity, resulting in greater
          comprehension and more prepared graduates.
          <br />
          <br />
          Maintained a roster of students, organized a complex scheduling system
          in order to ensure student’s personal needs are met, & communicated
      ...
      <Accordion className={classes.lastAccordion}>
        ...
        <AccordionDetails>
          ...
          <br /> Bachelor of Business Administration | Major: Marketing
          <br />
          GPA: 3.91
          <br /> Summer 2016
        </AccordionDetails>
